#!/usr/bin/env python
"""
Setup script for vaby_models_dti
"""
import os
import subprocess
import re
...
KWARGS = {
    'name' : 'vaby_models_dti',
    'version' : get_version(MODULE_DIR),
    'description' : 'VABY models for DTI',
    ...
    'entry_points' : {
        'vaby.models' : [
            'dti_ballandstick=vaby_models_dti:BallAndStickModel',
        ],
    },
    'classifiers' : [
